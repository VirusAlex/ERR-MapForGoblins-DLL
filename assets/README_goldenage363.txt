...
For the Elden Ring Golden Age overhaul (version 3.6.3).
Loot & world-map icons generated from Golden Age 3.6.3's own game data.
...
IMPORTANT: this build is generated from Golden Age 3.6.3. If you run a
different Golden Age version, use the matching Map For Goblins build (see
the mod page) - on a different version markers can be slightly off.

============================================================
Install (into an existing Golden Age 3.6.3 install)
============================================================
